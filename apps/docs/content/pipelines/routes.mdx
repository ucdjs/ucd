---
title: Routes
description: Define filters, parsers, transforms, route data, caching, and outputs
---
...
See [/pipelines/filters](/pipelines/filters) for the full helper set, including `byDir`, `byExt`, `byGlob`, `byPath`, `bySource`, `byProp`, and the filter combinators.
