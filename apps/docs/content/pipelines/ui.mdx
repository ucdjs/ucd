---
title: UI
description: Inspect definitions, executions, logs, traces, and graphs with the Pipeline Server
---

# Pipeline Server UI

The pipeline UI ships as part of `@ucdjs/pipelines-server`. The CLI starts it with `ucd pipelines run --ui`, and the server gives you a focused interface for debugging pipeline definitions and individual executions.
