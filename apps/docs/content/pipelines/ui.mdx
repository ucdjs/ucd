...
The pipeline UI now ships as part of `@ucdjs/pipelines-server`. It provides a web-based interface for visualizing pipeline execution, inspecting logs, and debugging route dependencies.
