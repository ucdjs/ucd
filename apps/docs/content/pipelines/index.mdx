...
- **`@ucdjs/pipelines-server`**: The deployable pipeline application and server, including the built-in web UI for exploring execution, viewing DAGs, inspecting artifacts, and debugging pipeline runs.
