...
The bridge supports all bridge hooks for monitoring and debugging operations. See the [Hooks documentation](/docs/core/fs-bridge/hooks) for complete details and examples.
