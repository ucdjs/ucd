...
The `@ucdjs/client` package provides a type-safe API client for interacting with the UCD.js API. It exposes resource-based helpers for Unicode data files, versions, manifests, and published server configuration.
