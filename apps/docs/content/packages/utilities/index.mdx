...
<Cards>
  <Card title="Shared" href="/packages/utilities/shared" description="Shared utilities used across UCD.js packages." />
  <Card title="Path Utils" href="/packages/utilities/path-utils" description="Path manipulation utilities for working with file paths." />
  <Card title="Environment" href="/packages/utilities/env" description="Environment configuration and variable management." />
  <Card title="Utils" href="/packages/utilities/utils" description="General utility functions." />
</Cards>
