...
<Callout type="warn">
  This page documents deprecated `@ucdjs/fs-bridge` capabilities. New code should use <a href="/packages/fs-backend/specification/features">FS Backend features</a> instead.
</Callout>
