...
<Callout type="warn">
  `@ucdjs/fs-bridge` is deprecated. Use <a href="/packages/fs-backend"><code>@ucdjs/fs-backend</code></a> for new code and follow the <a href="/packages/fs-backend/migration-from-fs-bridge">migration guide</a> when moving existing consumers.
</Callout>
