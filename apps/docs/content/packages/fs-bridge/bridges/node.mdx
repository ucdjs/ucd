...
<Callout type="warn">
  This bridge is part of deprecated `@ucdjs/fs-bridge`. Prefer the <a href="/packages/fs-backend/bridges/node">FS Backend Node backend</a> for new code, and use the <a href="/packages/fs-backend/migration-from-fs-bridge">migration guide</a> when switching existing consumers.
</Callout>
