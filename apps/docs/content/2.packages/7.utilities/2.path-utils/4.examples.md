...
---
Use `resolveSafePath` for all user-provided paths before file operations.
::
...
icon: i-lucide-code
---
Use `instanceof` checks to handle different error types specifically.
::
