...
Bridges automatically detect which optional operations they support. For complete documentation on checking and asserting capabilities, see the [Capabilities documentation](/core/fs-bridge/specification/capabilities).
...
All bridges support hooks for monitoring, debugging, and logging. For complete documentation on available hooks, payload types, and usage examples, see the [Hooks documentation](/core/fs-bridge/hooks).
...
The bridge system defines several error types for different error scenarios. For complete documentation on error types and error handling patterns, see the [Errors documentation](/core/fs-bridge/specification/errors).
