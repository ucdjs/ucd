...
Processed outputs and derived data packages are persisted via `@ucdjs/ucd-store`, which delegates all I/O to an `fs-bridge` implementation. Two bridges exist out of the box:
