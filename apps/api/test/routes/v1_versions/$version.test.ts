...
describe("v1_versions", () => {
  ...
  describe("GET /api/v1/versions/{version}/file-tree", () => {
    const files: TraverseEntry[] = [
      { type: "file", name: "file1.txt", path: "Public/15.1.0/ucd/file1.txt", lastModified: 1755287100000 },
      { type: "file", name: "file2.txt", path: "Public/15.1.0/ucd/file2.txt", lastModified: 1755287100000 },
      { type: "directory", name: "subdir", path: "Public/15.1.0/ucd/subdir", children: [], lastModified: 1755287100000 },
      { type: "file", name: "file3.txt", path: "Public/15.1.0/ucd/subdir/file3.txt", lastModified: 1755287100000 },
      { type: "file", name: "emoji-data.txt", path: "Public/15.1.0/ucd/emoji/emoji-data.txt", lastModified: 1755287100000 },
    ];
