/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./wrangler-types.d.ts` (hash: 88e96ebe30807a58e6a08d839ca61b75)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		UCD_BUCKET: R2Bucket;
		UCDJS_TASK_API_KEY: SecretsStoreSecret;
		CF_VERSION_METADATA: WorkerVersionMetadata;
		API_VERSION: "x.y.z";
		ENVIRONMENT: "production";
		MANIFEST_UPLOAD_WORKFLOW: Workflow<Parameters<import("./src/index").ManifestUploadWorkflow['run']>[0]['payload']>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_VERSION" | "ENVIRONMENT">> {}
}
