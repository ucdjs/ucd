...
export async function getAllVersionsFromList(): Promise<UnicodeVersion[]> {
...
export async function getVersionFromList(version: string): Promise<UnicodeVersion | null> {
  try {
