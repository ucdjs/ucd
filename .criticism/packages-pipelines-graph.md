...
- Like the rest of the pipeline packages, it has tests under [packages/pipelines/pipeline-graph/test](/Users/luxass/dev/ucdjs/ucd/packages/pipelines/pipeline-graph/test) but no package-local `test` script.
...
2. Add package-local tests.
3. Add actual graph diagrams and screenshots where this package is documented.
