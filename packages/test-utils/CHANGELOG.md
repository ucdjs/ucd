...
## [1.0.2](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1...@ucdjs/test-utils@1.0.2) (2026-05-03)


*No significant changes*

##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1...@ucdjs/test-utils@1.0.2)


## [1.0.1](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.11...@ucdjs/test-utils@1.0.1) (2026-04-04)


*No significant changes*

##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.11...@ucdjs/test-utils@1.0.1)


## [1.0.1-beta.11](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.11...@ucdjs/test-utils@1.0.1-beta.11) (2026-04-03)


*No significant changes*

##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.11...@ucdjs/test-utils@1.0.1-beta.11)
...
##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.8...@ucdjs/test-utils@1.0.1-beta.9)


## [1.0.1-beta.8](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.8...@ucdjs/test-utils@1.0.1-beta.8) (2026-03-29)
...
### 🐞 Bug Fixes
* address migration review feedback ([beb69de5](https://github.com/ucdjs/ucd/commit/beb69de5f036794c46a3aad4345900ac3b4ba8d3)) (by [@luxass](https://github.com/luxass))
## [1.0.1-beta.7](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.6...@ucdjs/test-utils@1.0.1-beta.7) (2026-02-27)


*No significant changes*

##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.6...@ucdjs/test-utils@1.0.1-beta.7)


## [1.0.1-beta.6](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.5...@ucdjs/test-utils@1.0.1-beta.6) (2026-02-19)


*No significant changes*

##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.5...@ucdjs/test-utils@1.0.1-beta.6)


## [1.0.1-beta.5](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.4...@ucdjs/test-utils@1.0.1-beta.5) (2026-02-16)
...
## [1.0.1-beta.4](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.1-beta.3...@ucdjs/test-utils@1.0.1-beta.4) (2026-02-15)
...
* add pipeline module source and exports ([6250329d](https://github.com/ucdjs/ucd/commit/6250329dadada43dc10c5e036d23e2158b0d48c9)) (by [@luxass](https://github.com/luxass))
* add async iterable utilities and tests ([30cc648d](https://github.com/ucdjs/ucd/commit/30cc648d18806edb810918f3716cb6ce33d32849)) (by [@luxass](https://github.com/luxass))
...
* integrate @unicode-utils/core and enhance file handling ([4c2d2df4](https://github.com/ucdjs/ucd/commit/4c2d2df4254b57868fa6f16cd39b3278d4458c4a)) (by [@luxass](https://github.com/luxass))
* add file path handling and tree structure utilities ([47862911](https://github.com/ucdjs/ucd/commit/478629110dc01283d3307b1fa1caed1a4fc3fd11)) (by [@luxass](https://github.com/luxass))
* add mock content ([f71c644f](https://github.com/ucdjs/ucd/commit/f71c644fe3f3c51913cad792b7e44fb73984141e)) (by [@luxass](https://github.com/luxass))
* add @luxass/utils dependency ([30400f34](https://github.com/ucdjs/ucd/commit/30400f3437c60e9832de2250d0a3fa995c19972a)) (by [@luxass](https://github.com/luxass))
* add support for error fields validation ([1b20f27e](https://github.com/ucdjs/ucd/commit/1b20f27e848599a3a6348798b7d1328c9dddeb17)) (by [@luxass](https://github.com/luxass))
* add basePath option to memory file system bridge ([fe114474](https://github.com/ucdjs/ucd/commit/fe11447472d0bd575bd132f58c9dbdcd82f707a4)) (by [@luxass](https://github.com/luxass))
* enhance error message matching in response matcher ([c926df37](https://github.com/ucdjs/ucd/commit/c926df37b2ecdace29a8c41907699c254add56be)) (by [@luxass](https://github.com/luxass))
* add custom response matchers for API error handling ([bff3f2af](https://github.com/ucdjs/ucd/commit/bff3f2af4a3391c17fbb1f0602383fc3b63393d8)) (by [@luxass](https://github.com/luxass))
* add exports for matchers types and Vitest setup ([b5014167](https://github.com/ucdjs/ucd/commit/b501416787a6743be64c9f5bfa1229cd5660e97e)) (by [@luxass](https://github.com/luxass))
...
* add `RawResponse` to support responses without content-type header set. ([58fcb080](https://github.com/ucdjs/ucd/commit/58fcb0808f38057c693aaf20a2409b7a0bd78579)) (by [@luxass](https://github.com/luxass))
* support openapi path params in mockFetch ([c61d6661](https://github.com/ucdjs/ucd/commit/c61d6661b65e1d43ddfc6db128d7e2610293bd0c)) (by [@luxass](https://github.com/luxass))
* implement mkdir for memory-fs-bridge ([a93dcf8a](https://github.com/ucdjs/ucd/commit/a93dcf8a20a1868d688b0db766f50a0e086730c5)) (by [@luxass](https://github.com/luxass))
* add intellisense for files version ([db3c3335](https://github.com/ucdjs/ucd/commit/db3c3335ac701b5beee03a60bee947928c16f121)) (by [@luxass](https://github.com/luxass))
* add support setting before and after functions via configure ([d83981ec](https://github.com/ucdjs/ucd/commit/d83981ecd6833776b3c498e8b39ceee26c61ae55)) (by [@luxass](https://github.com/luxass))
* add support for setting files ([590e8296](https://github.com/ucdjs/ucd/commit/590e829688863280bd9027f4d1bd4ba1b6941121)) (by [@luxass](https://github.com/luxass))
* introduce read-only filesystem bridge and enhance test coverage ([a0e421d2](https://github.com/ucdjs/ucd/commit/a0e421d2be13b805a32fb3ec84b5f4ffb7c6beb7)) (by [@luxass](https://github.com/luxass))
...
* use `:wildcard*` in route handlers ([fd0d0bfd](https://github.com/ucdjs/ucd/commit/fd0d0bfdbfb2f9984674f702a1411876cec20da6)) (by [@luxass](https://github.com/luxass))
* use correct files type ([47de85d6](https://github.com/ucdjs/ucd/commit/47de85d656fa4ee7af5216d0b71bd2ac0144964e)) (by [@luxass](https://github.com/luxass))
* flatten files in well-known expected files ([f0de5248](https://github.com/ucdjs/ucd/commit/f0de5248a56c2c14029d0ce8400ead6ba8e3dbd1)) (by [@luxass](https://github.com/luxass))
...
## [1.0.1-beta.0](https://github.com/ucdjs/ucd/compare/@ucdjs/test-utils@1.0.0...@ucdjs/test-utils@1.0.1-beta.0) (2026-02-15)
