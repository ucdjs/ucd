...
describe("lockfile hash command", () => {
  ...
  it("should show help when --help flag is passed", async () => {
    ...
    expect(capture.containsLog("Compute content hash for a file")).toBe(true);
    expect(capture.containsLog("--strip-header")).toBe(true);
    expect(capture.containsLog("--compare")).toBe(true);
