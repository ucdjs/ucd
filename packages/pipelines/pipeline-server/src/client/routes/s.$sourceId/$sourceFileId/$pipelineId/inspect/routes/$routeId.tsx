        ...
        <div className="space-y-5 bg-muted/5 px-6 py-5">
          ...
          <div className="grid gap-4 border-t border-border/60 pt-4 lg:grid-cols-2">
            <div className="space-y-2">
              ...
              <code className="block break-all border border-border/60 bg-muted/10 px-3 py-3 text-sm">
            ...
            ? (
                <div className="grid gap-3">
                  {selectedRoute.outputs.map((output, idx) => (
                    <div key={`${output.dir ?? "none"}-${output.fileName ?? "none"}`} className="border border-border/60 p-4">
