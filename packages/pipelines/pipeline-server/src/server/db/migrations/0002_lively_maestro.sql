...
ALTER TABLE `events` ADD `workspace_id` text NOT NULL DEFAULT '';--> statement-breakpoint
CREATE INDEX `events_workspace_execution_idx` ON `events` (`workspace_id`,`execution_id`);--> statement-breakpoint
ALTER TABLE `execution_logs` ADD `workspace_id` text NOT NULL DEFAULT '';--> statement-breakpoint
...
ALTER TABLE `executions` ADD `workspace_id` text NOT NULL DEFAULT '';--> statement-breakpoint
