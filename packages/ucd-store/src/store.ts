...
import type { UCDStoreManifest, UnicodeFileTreeNode } from "@ucdjs/schemas";
...
export class UCDStore {
  ...
  async getFileTree(version: string, extraFilters?: Pick<PathFilterOptions, "include" | "exclude">): Promise<OperationResult<UnicodeFileTreeNode[], StoreError>> {
