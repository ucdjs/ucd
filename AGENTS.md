...
- See [Project Architecture](apps/docs/content/contributing/development/project.mdx) for details
...
- [Project Architecture](apps/docs/content/contributing/development/project.mdx)
